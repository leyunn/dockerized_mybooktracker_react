          ...
          render={({ location }) => (
            <>
              ...
              <img onClick={()=>dispatch(aopen())} alt="logo" className="icon" src={icon} style={{height:"22px", width:"30px", marginTop:"12px"}} />
                <Tab label="Search" value={allTabs[0]} component={Link} to={allTabs[0]} onClick={()=>switchTab(0)} />
                <Tab label="Home" value={allTabs[1]} component={Link} to={allTabs[1]} onClick={()=>switchTab(1)} />
                <Tab label="My books" value={allTabs[2]} component={Link} to={allTabs[2]} onClick={()=>switchTab(2)} />
                {(location.pathname!=="/")?
